...
(function () {
  ...
  window.salvarPerfilPermissao = async function () {
    ...
    try { await window.chamarApi('/api/admin-perfis', { acao: 'salvar', id: $('perm-profile-id').value || undefined, nome, descricao: $('perm-profile-description').value, permissoes }); await window.carregarAdmin(); renderPerfis(); window.toast('Perfil salvo.'); }
